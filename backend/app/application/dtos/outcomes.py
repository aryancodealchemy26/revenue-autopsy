...
class RecordOutcomeDTO(BaseModel):
    """Use-case input DTO for recording a measured intervention outcome."""
    ...
    @classmethod
    def check_amount(cls, v: object) -> Decimal:
